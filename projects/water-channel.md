...
Since the limiting factor on the execution of the experiment was facility availbilty compared to the 3D printing budget, it was decided that constructing a single adjustable angle-of-attack mechanism would cause unnecesary delays due to additional assembly time and angle tolerance verification. 
