...
The motivating insight from both Tang et al [1] and Deubel et al [2] was that the corugated patterns would create lower pressure on the top surface of the airfoil, increasing lift.
 ...
 <figure style="flex:1 1 260px; margin:0; text-align:center;">
  ...
  <figure style="flex:1 1 260px; margin:0; text-align:center;">
    ...
    >
    <figcaption style="font-size:0.9em; color:#555; margin-top:6px;">
      Diagram from Deubel et al [2] showing the desired vortex generation of a corrugated wing (mirrored)
    </figcaption>
  </figure>
...
- **Designing for rapid iteration under time constraints:**  
...
- Data acquisition and processing (NI DAQ hardware and LabVIEW/MATLAB butterworth filter)
